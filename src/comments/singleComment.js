...
import { editComment, removeComment,addComment } from "../provider/commentSlice";
      ...
      <div className="comment-body">
        ...
        <div className="comment-body-buttons">
          {activeRes ? (
            ...
            item.parentId === null && (
              <Button text='پاسخ به' isOpen={activeRes} setIsOpen={setActiveRes}/>
            )
          )}
          ...
          {activeEdit & item.id ? (
            ...
            <Button text='ویرایش' isOpen={activeEdit} setIsOpen={setActiveEdit}/>
          )}
        </div>
